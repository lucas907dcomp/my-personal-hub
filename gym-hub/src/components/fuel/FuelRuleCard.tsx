...
export function FuelRuleCard({ ratioPercentage }: FuelRuleCardProps) {
  return (
    <div className="bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-500/30 p-4 rounded-xl flex items-center gap-4">
      <div className="text-3xl" aria-hidden="true">💡</div>
      <div>
        <h4 className="font-semibold text-emerald-700 dark:text-emerald-300">Regra de Abastecimento:</h4>
